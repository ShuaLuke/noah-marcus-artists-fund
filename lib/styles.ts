...
export const cta = {
  ...
  // Blue→pink gradient (an "Apple-style" fade) echoing the sunset sky, using the
  // deeper tokens so the white label stays legible.
  primary:
    "inline-block rounded-full bg-gradient-to-r from-blueDeep to-roseDeep px-7 py-3 font-semibold text-paper transition-transform hover:-translate-y-0.5",
...
export const eyebrow =
  "text-sm font-medium uppercase tracking-[0.2em] text-roseDeep";
